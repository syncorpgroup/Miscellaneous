...
class Urls(object):
    ...
    def __init__(self, country=COUNTRY_USA):
        ...
        self.urls = {
            COUNTRY_PA: {
                'find_url' : 'https://order.golo01.dominos.com/store-locator-international/locate/store?Latitude={latitude}&Longitude={longitude}',
                'info_url' : 'https://order.golo01.dominos.com/power/store/{store_id}/profile',
                'menu_url' : 'https://order.golo01.dominos.com/power/store/{store_id}/menu?lang={lang}&structured=true',
                'place_url' : 'https://order.golo01.dominos.com/power/place-order',
                'price_url' : 'https://order.golo01.dominos.com/power/price-order',
                'track_by_order' : 'https://order.golo01.dominos.com/orderstorage/GetTrackerData?StoreID={store_id}&OrderKey={order_key}',
                'track_by_phone' : 'https://order.golo01.dominos.com/orderstorage/GetTrackerData?Phone={phone}',
                'validate_url' : 'https://order.golo01.dominos.com/power/validate-order',
                'coupon_url' : 'https://order.golo01.dominos.com/power/store/{store_id}/coupon/{couponid}?lang={lang}',
            },
            COUNTRY_USA: {
